...
- [ ] Commit and push all v4.3.1 release changes to `main`.
- [ ] GitHub Pages verification and deployment workflow succeeds.
- [ ] Hosted suite and Optical Transfer return HTTP 200.
- [ ] Hosted release artifacts match committed `dist/` bytes by SHA-256.
- [ ] Fresh hosted browser confirms square QR geometry and the v4.3.1 behavior markers.
- [ ] Backfill the `v4.3.0` tag and GitHub Release at deployed commit `cc14f0c`.
- [ ] Push the `v4.3.1` tag and publish its GitHub Release.
